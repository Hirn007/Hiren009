				...
				<div class="col-md-5">
					<div class="product-details">
						...
						<form action="{{ route('add.cart') }}" method="POST">
							...
							<input type="hidden" name="price" value="{{ $product->price ?? 980 }}">
							<div class="add-to-cart">
								<div class="qty-label">
									Qty
									<div class="input-number">
										<!-- input name "qty" zaruri hai -->
			...
			<div class="row">
				...
				<div class="col-md-3 col-xs-6">
					<div class="product">
						...
						<form action="{{ route('add.cart') }}" method="POST">
							@csrf
							<input type="hidden" name="product_id" value="{{ $item->id ?? 1 }}">
							<input type="hidden" name="price" value="{{ $item->price ?? 980 }}">
